...
function Edit() {
    ...
    const handleUpdate = (e) => {
        e.preventDefault();
        axios.put(`https://647b6592d2e5b6101db13fff.mockapi.io/crud/${id}`,{
            e_name: name,
            e_age: age,
            e_email: email
        }).then(() => {
     ...
     <div className='row' >
        ...
        <div className='mb-2 mt-2'>
            ...
            <form onSubmit={handleUpdate}>
                ...
                <input type='number' value={age}  onChange={(e) => setAge(e.target.value)} placeholder='Enter Your Age' className='form-control' />
                </div>
